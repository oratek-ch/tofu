...
## Technical files
### Mechanical
- [STEP files](../tofu/_assets//TOFU.zip ':ignore :target=_blank')
- [Mechanical drawings](../tofu/_assets//TOFU-drawing.pdf ':ignore :target=_blank')  

### Electrical
- [Schematics](../tofu/_assets//TOFU-schematics.pdf ':ignore :target=_blank')  
- [Components reference](../tofu/_assets//TOFU-references.pdf ':ignore :target=_blank')  
...
- [CE Declaration of Conformity](../tofu/_assets/conformity//Oratek-Declaration_of_Conformity_for_TOFU_CE.pdf ':ignore :target=_blank')  
- [FCC Declaration of Conformity](../tofu/_assets/conformity//Oratek-Declaration_of_Conformity_for_TOFU_FCC.pdf ':ignore :target=_blank')  
